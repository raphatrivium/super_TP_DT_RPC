...
void plot_standard_deviation(){
    ...
    TH1F *hist1 = (TH1F*)file1->Get("eff");
    TH1F *hist2 = (TH1F*)file2->Get("eff");

    std::vector<double> vec_values1;
    std::vector<double> vec_values2;

    hist1 = (TH1F*)file1->Get("histogram_ph2TpgPhiEmuAm_BX_wheel_m2_station_1");
    stddev = get_standard_deviation( hist1 );
    vec_values1.push_back(stddev);
    std::cout << "stddev " << stddev << std::endl;
    hist2 = (TH1F*)file2->Get("histogram_ph2TpgPhiEmuAm_BX_wheel_m2_station_1");
    stddev = get_standard_deviation( hist2 );
    vec_values2.push_back(stddev);
    ...
    TH2F *histogram_std_noRPC = new TH2F("histogram_std_noRPC", "Wheels; Wheels ; #sigma", 21, 0, 21, 100, 0, 10);
    TH2F *histogram_std_withRPC = new TH2F("histogram_std_withRPC", "Wheels; Wheels ; #sigma", 21, 0, 21, 100, 0, 10);
    ...
    histogram_std_noRPC->GetYaxis()->SetTitle("#sigma");
    histogram_std_withRPC->GetYaxis()->SetTitle("#sigma");
    ...
    canvas->SaveAs("histograms/standard_deviation.png"); // Save the canvas as an image
